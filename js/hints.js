var hints = {
    pension_age: "Пенсійний вік не можна так взяти і підняти. Проти виступають популісти з опозиції і більшість населення. На нашій моделі ви можете підняти пенсійний вік на 2,5 роки протягом п’яти років. У більшості країн Єропейського Союзу пенсійний вік становить 65 років. Тривалість життя в Україні і ЄС тих, хто доживо до 60, відрізняється не критично.",
